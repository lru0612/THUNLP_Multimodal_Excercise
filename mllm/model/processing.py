...
from .image_processing import ModelBatchFeature


class ModelProcessor(ProcessorMixin):
    r"""
    Constructs a MLLM processor which wraps a MLLM image processor and a MLLM tokenizer into a single processor.

    [`ModelProcessor`] offers all the functionalities of [`ModelImageProcessor`] and [`LlamaTokenizerWrapper`]. See the
    [`~ModelProcessor.__call__`] and [`~ModelProcessor.decode`] for more information.

    Args:
        image_processor ([`ModelImageProcessor`], *optional*):
